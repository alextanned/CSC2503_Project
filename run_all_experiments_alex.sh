...
echo "============================================================"
echo "Starting All Experiments (12 total)"
echo "============================================================"
echo ""
...
python eval_performance.py --checkpoint checkpoints/vit_baseline/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_baseline.txt

echo "Evaluating ViT - Feature β=0.5..."
python eval_performance.py --checkpoint checkpoints/vit_feat_b0.5/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_feat_b0.5.txt

echo "Evaluating ViT - Feature β=1.0..."
python eval_performance.py --checkpoint checkpoints/vit_feat_b1.0/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_feat_b1.0.txt

echo "Evaluating ViT - Feature β=2.0..."
python eval_performance.py --checkpoint checkpoints/vit_feat_b2.0/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_feat_b2.0.txt

echo "Evaluating ViT - Logit γ=0.5..."
python eval_performance.py --checkpoint checkpoints/vit_logit_g0.5/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_logit_g0.5.txt

echo "Evaluating ViT - Logit γ=1.0..."
python eval_performance.py --checkpoint checkpoints/vit_logit_g1.0/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_logit_g1.0.txt

echo "Evaluating ViT - Logit γ=2.0..."
python eval_performance.py --checkpoint checkpoints/vit_logit_g2.0/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_logit_g2.0.txt

echo "Evaluating ViT - Combined..."
python eval_performance.py --checkpoint checkpoints/vit_combined/student_latest.pth --backbone vit_tiny --batch-size 8 | tee results/vit_combined.txt
